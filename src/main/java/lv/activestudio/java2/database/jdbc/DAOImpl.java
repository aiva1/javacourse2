...
import lv.activestudio.java2.database.DBException;
...
public class DAOImpl {
    ...
    private void registerJDBCDriver() {
        try {
            ...
            Logger.getRootLogger().debug("Exception while registering JDBC driver!");
            e.printStackTrace();
        }
    }
    ...
    private void initDatabaseConnectionProperties() {
        ...
        try {
            ...
            Logger.getRootLogger().debug("Exception while reading JDBC configuration from file = " + DB_CONFIG_FILE);
            e.printStackTrace();
        }
    }
    ...
    protected Connection getConnection() throws DBException {
        try{
            ...
            Logger.getRootLogger().debug("Exception while getting connection to database");
            e.printStackTrace();
    ...
    protected void closeConnection(Connection connection) throws DBException {
        try {
            ...
            Logger.getRootLogger().debug("Exception while closing connection to database");
            e.printStackTrace();
            throw new DBException(e);
        }
    }
